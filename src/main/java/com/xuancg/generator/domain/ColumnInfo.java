...
import com.xuancg.generator.util.JsonUtil;
...
public class ColumnInfo  implements Serializable{
	...
	public void setColumnComment(String columnComment) throws Exception {
		// 根据列描述解析列的配置信息
		if (null != columnComment && !columnComment.isEmpty() && columnComment.startsWith("{")) {
			this.configInfo = JsonUtil.json2Pojo(columnComment, ColumnConfigInfo.class);
	...
	public String toString() {
		return "ColumnInfo [columnName=" + columnName + ", dataType=" + dataType + ", columnComment=" + columnComment
				+ ", configInfo=" + configInfo + ", attrType=" + attrType + ", attrName=" + attrName + ", attrname="
				+ attrname + ", extra=" + extra + "]";
	}
